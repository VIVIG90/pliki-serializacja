...
import java.util.*; //tu jest arraylista
...
public class Main {
    ...
    Osoba o3 = new Osoba("Patrycja", "Pietraszek", 1995);
...
/* Zadania:
 * 1. Utworz liste ArrayList<Osoba>. -> zrobione
 * 2. Dodaj do niej dwa obiekty klasy Osoba. -> zrobione dla 3
 * 3. Otworz kolejny plik do zapisu i zapisz do niego obiekt klasy ArrayList<Osoba>. -> zrobione
 * 4. Wczytaj obiekt klasy ArrayList<Osoba> z drugiego pliku. -> zrobione
 * 5. Wyswietl go na ekranie. -> zrobione
 */
